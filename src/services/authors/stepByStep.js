...
const authorsMockRouter = express.Router(); // Here we use Router express functionality to provide Routing to the server
...
export default authorsMockRouter; // Not to forget to export to be able to use it in the server
